...
void lp_thread_timer_publish(lp_thread_timer *timer, lua_State *state,
...
void lp_thread_timer_begin_collection(lp_thread_timer *timer);
void lp_thread_timer_end_collection(lp_thread_timer *timer);
